The following is a list of assets used in the ethercryptocoin source and their proper attribution.
...
### Info
* Designer: md2k7
* Site: https://ethercryptocointalk.org/index.php?topic=15276.0
...
### Info
* Designer: Jonas Schnelli (based on the original ethercryptocoin logo from Bitboy)
* License: MIT
